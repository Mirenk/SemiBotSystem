    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recommend_label', models.ManyToManyField(related_name='recommend_task', to='data_manager.Label')),
            ],
        ),
        migrations.AddField(
            model_name='task',
            name='require_label',
            field=models.ManyToManyField(related_name='require_task', to='data_manager.Label'),
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('name', 'work_datetime'), name='name_datetime_unique'),
        ),
    ]
