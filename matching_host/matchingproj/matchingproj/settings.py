"""
Django settings for matchingproj project.
...
ROOT_URLCONF = 'matchingproj.urls'
...
WSGI_APPLICATION = 'matchingproj.wsgi.application'
...
MATCHING_DATAMANAGE_HOST = os.environ.get('DATAMANAGE_HOST', 'semi_data:50051')
